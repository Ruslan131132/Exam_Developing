...
//    qDebug() << data;
    ...
    //     вызывается WinAPI-функция GetModuleHandle
        ...
        const QByteArray hash0_base64 = QByteArray("KLU5AqgAKc3Ax6zqTjrtCxl7w8xFMA0qaXNcvbdF69U=");//задаем константу, в которой будет храниться эталонный хэш
...
//            int result = QMessageBox::critical(nullptr, "Внимание!", "Произошла модификация приложения!!");
//            return -1;
//        }
